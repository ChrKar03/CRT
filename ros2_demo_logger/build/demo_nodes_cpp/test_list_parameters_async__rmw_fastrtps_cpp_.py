...
def generate_test_description():
    ...
    exes_and_params = '/home/chris/ros2_ws/build/demo_nodes_cpp/list_parameters_async'.split(';')
...
class TestExecutablesTutorial(unittest.TestCase):
    ...
    def test_processes_output(self, proc_output, processes_under_test):
        ...
        output_files = '/home/chris/ros2_ws/src/demos/demo_nodes_cpp/test/list_parameters_async'.split(';')
