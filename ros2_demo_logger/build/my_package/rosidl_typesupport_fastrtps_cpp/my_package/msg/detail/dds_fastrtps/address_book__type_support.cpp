...
#include "my_package/msg/detail/address_book__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_package::msg::AddressBook & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_package::msg::AddressBook & ros_message)
{
  // Member: first_name
  cdr >> ros_message.first_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_package::msg::AddressBook;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_package::msg::AddressBook *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_package::msg::AddressBook *>(
    untyped_ros_message);
...
{
  return &my_package::msg::typesupport_fastrtps_cpp::_AddressBook__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_package, msg, AddressBook)() {
  return &my_package::msg::typesupport_fastrtps_cpp::_AddressBook__handle;
}
