...
my_package__msg__AddressBook__init(my_package__msg__AddressBook * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->first_name)) {
    my_package__msg__AddressBook__fini(msg);
    return false;
  }
  // last_name
...
my_package__msg__AddressBook__create()
{
  ...
  my_package__msg__AddressBook * msg = (my_package__msg__AddressBook *)allocator.allocate(sizeof(my_package__msg__AddressBook), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_package__msg__AddressBook));
  bool success = my_package__msg__AddressBook__init(msg);
  if (!success) {
...
my_package__msg__AddressBook__Sequence__init(my_package__msg__AddressBook__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_package__msg__AddressBook * data = NULL;

  if (size) {
    data = (my_package__msg__AddressBook *)allocator.zero_allocate(size, sizeof(my_package__msg__AddressBook), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_package__msg__AddressBook__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_package__msg__AddressBook__fini(&data[i - 1]);
      }
...
my_package__msg__AddressBook__Sequence__fini(my_package__msg__AddressBook__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_package__msg__AddressBook__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_package__msg__AddressBook__Sequence * array = (my_package__msg__AddressBook__Sequence *)allocator.allocate(sizeof(my_package__msg__AddressBook__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_package__msg__AddressBook__Sequence__init(array, size);
  if (!success) {
...
my_package__msg__AddressBook__Sequence__destroy(my_package__msg__AddressBook__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_package__msg__AddressBook__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_package__msg__AddressBook__Sequence__are_equal(const my_package__msg__AddressBook__Sequence * lhs, const my_package__msg__AddressBook__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_package__msg__AddressBook__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_package__msg__AddressBook__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_package__msg__AddressBook);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_package__msg__AddressBook * data =
      (my_package__msg__AddressBook *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_package__msg__AddressBook__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_package__msg__AddressBook__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_package__msg__AddressBook__copy(
