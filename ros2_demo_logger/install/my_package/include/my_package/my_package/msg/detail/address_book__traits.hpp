...
#ifndef MY_PACKAGE__MSG__DETAIL__ADDRESS_BOOK__TRAITS_HPP_
#define MY_PACKAGE__MSG__DETAIL__ADDRESS_BOOK__TRAITS_HPP_
...
inline void to_yaml(
  const my_package::msg::AddressBook & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const my_package::msg::AddressBook & msg)
{
  return my_package::msg::to_yaml(msg);
}

template<>
inline const char * data_type<my_package::msg::AddressBook>()
{
  return "my_package::msg::AddressBook";
}

template<>
inline const char * name<my_package::msg::AddressBook>()
{
  return "my_package/msg/AddressBook";
}

template<>
struct has_fixed_size<my_package::msg::AddressBook>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<my_package::msg::AddressBook>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<my_package::msg::AddressBook>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MY_PACKAGE__MSG__DETAIL__ADDRESS_BOOK__TRAITS_HPP_
